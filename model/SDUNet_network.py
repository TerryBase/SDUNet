...
class SDUNet(nn.Module):
    ...
    def __init__(self, in_channels:int = 1, out_classes:int = 2, hidden_features:int = 4, keep_prob:float = 0.5, drop_size = 3):
        super().__init__()
        self.in_channels = in_channels
        self.out_classes = out_classes
        self.hidden_features = hidden_features
        layer_channels = [hidden_features, 2 * hidden_features, 4 * hidden_features, 8 * hidden_features, 16 * hidden_features]
